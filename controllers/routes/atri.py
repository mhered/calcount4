...
class Atri:
	def __init__(self, state: Any):
		...
		self.Table1 = state["Table1"]
		self.LineChart1 = state["LineChart1"]
	...
	@property
	def Table1(self):
		self._getter_access_tracker["Table1"] = {}
		return self._Table1
	@Table1.setter
	def Table1(self, new_state):
		self._setter_access_tracker["Table1"] = {}
		global default_state
		self._Table1 = Table(new_state, default_state["Table1"])

	@property
	def LineChart1(self):
		self._getter_access_tracker["LineChart1"] = {}
		return self._LineChart1
	@LineChart1.setter
	def LineChart1(self, new_state):
		self._setter_access_tracker["LineChart1"] = {}
		global default_state
		self._LineChart1 = LineChart(new_state, default_state["LineChart1"])
...
class TablecustomClass:
	def __init__(self, state, def_state):
		...
		self.rows: List[Any] = get_defined_value(state, def_state, "rows")
		self.cols: List[Any] = get_defined_value(state, def_state, "cols")
		self.checkboxSelection: bool = get_defined_value(state, def_state, "checkboxSelection")
		self.autoHeight: bool = get_defined_value(state, def_state, "autoHeight")
		self.numRows: int = get_defined_value(state, def_state, "numRows")
		self.rowHeight: int = get_defined_value(state, def_state, "rowHeight")
		self.selection: List[Any] = get_defined_value(state, def_state, "selection")
		self._setter_access_tracker = {}
		self._getter_access_tracker = {}
...
class Table:
	def __init__(self, state, def_state):
		...
		self.styles: TablestylesClass = get_defined_value(state, def_state, "styles")
		self.custom: TablecustomClass = get_defined_value(state, def_state, "custom")
		self._setter_access_tracker = {}
		self._getter_access_tracker = {}
	...
	def styles(self, state):
		self._setter_access_tracker["styles"] = {}
		self._styles = TablestylesClass(state, self._def_state["styles"])
	@property
	def custom(self):
		self._getter_access_tracker["custom"] = {}
		return self._custom
	...
	def custom(self, state):
		self._setter_access_tracker["custom"] = {}
		self._custom = TablecustomClass(state, self._def_state["custom"])
	def _to_json_fields(self):
		return {
			"styles": self._styles,
			"custom": self._custom,
...
class LineChartcustomClasscartesianGridClass:
	def __init__(self, state, def_state):
		self._setter_access_tracker = {}
		self._def_state = def_state
...
class LineChartcustomClassxAxisClass:
	def __init__(self, state, def_state):
		self._setter_access_tracker = {}
		self._def_state = def_state
...
class LineChartcustomClassyAxisClass:
	def __init__(self, state, def_state):
		self._setter_access_tracker = {}
		self._def_state = def_state
...
class LineChartcustomClasstoolTipClass:
	def __init__(self, state, def_state):
		self._setter_access_tracker = {}
		self._def_state = def_state
...
class LineChartcustomClasslegendClass:
	def __init__(self, state, def_state):
		self._setter_access_tracker = {}
		self._def_state = def_state
...
class LineChartcustomClass:
	def __init__(self, state, def_state):
		...
		self.cartesianGrid: LineChartcustomClasscartesianGridClass = get_defined_value(state, def_state, "cartesianGrid")
		self.data: List[Any] = get_defined_value(state, def_state, "data")
		self.xAxis: LineChartcustomClassxAxisClass = get_defined_value(state, def_state, "xAxis")
		self.yAxis: LineChartcustomClassyAxisClass = get_defined_value(state, def_state, "yAxis")
		self.toolTip: LineChartcustomClasstoolTipClass = get_defined_value(state, def_state, "toolTip")
		self.legend: LineChartcustomClasslegendClass = get_defined_value(state, def_state, "legend")
	...
	def cartesianGrid(self, state):
		...
		self._cartesianGrid = LineChartcustomClasscartesianGridClass(state, self._def_state["cartesianGrid"])
	@property
	def data(self):
	...
	def xAxis(self, state):
		...
		self._xAxis = LineChartcustomClassxAxisClass(state, self._def_state["xAxis"])
	@property
	def yAxis(self):
	...
	def yAxis(self, state):
		...
		self._yAxis = LineChartcustomClassyAxisClass(state, self._def_state["yAxis"])
	@property
	def toolTip(self):
	...
	def toolTip(self, state):
		...
		self._toolTip = LineChartcustomClasstoolTipClass(state, self._def_state["toolTip"])
	@property
	def legend(self):
	...
	def legend(self, state):
		...
		self._legend = LineChartcustomClasslegendClass(state, self._def_state["legend"])
	@property
	def options(self):
...
class LineChart:
	def __init__(self, state, def_state):
		...
		self.styles: LineChartstylesClass = get_defined_value(state, def_state, "styles")
		self.custom: LineChartcustomClass = get_defined_value(state, def_state, "custom")
		self._setter_access_tracker = {}
		self._getter_access_tracker = {}
	...
	def styles(self, state):
		self._setter_access_tracker["styles"] = {}
		self._styles = LineChartstylesClass(state, self._def_state["styles"])
	@property
	def custom(self):
		self._getter_access_tracker["custom"] = {}
		return self._custom
	...
	def custom(self, state):
		self._setter_access_tracker["custom"] = {}
		self._custom = LineChartcustomClass(state, self._def_state["custom"])
	def _to_json_fields(self):
		return {
			"styles": self._styles,
			"custom": self._custom,
